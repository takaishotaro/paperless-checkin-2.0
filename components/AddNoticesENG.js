...
import { UPDATE_NOTICES_ENG } from '../apollo/mutation'
...
const AddNoticesENG = (props) => {
  const [notices, setNotices] = useState(props.noticesENGData);
  const [newNotice, setNewNotice]=useState('')

  const [ updateNotices, { loading }] = useMutation(UPDATE_NOTICES_ENG,{
    variables: { noticesENG: notices },
  ...
  const reset = () => setNotices(props.noticesENGData)
