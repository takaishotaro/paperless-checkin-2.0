...
import { UPDATE_COVID_ENG } from '../apollo/mutation'
...
const AddNoticesENG = (props) => {
  const [notices, setNotices] = useState(props.covidENGData);
  const [newNotice, setNewNotice]=useState('')

  const [ updateNotices, { loading }] = useMutation(UPDATE_COVID_ENG,{
    variables: { covidENG: notices },
  ...
  const reset = () => setNotices(props.covidENGData)
