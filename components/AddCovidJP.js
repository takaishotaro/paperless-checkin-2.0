...
import { UPDATE_COVID_JP } from '../apollo/mutation'
...
const AddNoticesJP = (props) => {
  const [notices, setNotices] = useState(props.covidJPData);
  const [newNotice, setNewNotice]=useState('')

  const [ updateNotices, { loading }] = useMutation(UPDATE_COVID_JP,{
    variables: { covidJP: notices },
  ...
  const reset = () => setNotices(props.covidJPData)
